...
== Indexing test data
  ...
  $ curl "http://localhost:8983/solr/update/csv?f.subject_topic_facet.split=true&f.subject_topic_facet.separator=%5E" --data-binary @eresources-csv-edit.csv -H 'Content-type:text/plain; charset=utf-8' 

  This utilises the solr csv update manager, and splits the subject_topic_facet column based upon the %5E char (^). 

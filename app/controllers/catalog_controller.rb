...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field 'library', :label => 'Location', :limit => 10
    ...
    config.add_facet_field 'subject_era_facet', :label => 'Era', :limit => 10
    ...
    config.add_sort_field 'title_sort asc, pub_date_sort desc', :label => 'title (ascending)'
    config.add_sort_field 'title_sort desc, pub_date_sort desc', :label => 'title (descending)'

...
The project includes a .rvmrc file which will define a Ruby version and gemset that should be used for the project.  In this case ruby-1.9.3-p547 and gemset 'blah'.  
